...
public class PUT_UpdateUser_TestCase extends BaseTest {
	@SuppressWarnings("unchecked")
	@BeforeClass
	void postNewUsers() throws InterruptedException {
		...
		requestParameters.put("job", "zion resident");

		httpRequest.header("Content-Type", "application/json");
		httpRequest.body(requestParameters.toJSONString());

		response = httpRequest.request(Method.PUT, "/api/users/2" + empID);
